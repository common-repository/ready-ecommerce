...
[Ready! eCommerce Wordpress Plugin](http://readyshoppingcart.com/ecommerce-plugin/ "eCommerce Wordpress Plugin") with Shopping Cart online store v0.5.9 include:
...
== Changelog ==
= 0.6.0 =
 * Core functionality - added possibility to load tables from theme module
 * E4 payment addon - added products list to E4 checkout page
 * Orders Export addon - added possibility to show orders limited by date and/or status
 * Core functionality - Breadcrumbs - possibility to change breadcrumbs through filter
 * Added PRO addon - Google E-commerce Analytics
 * Minor issues fixes and code review

= 0.5.9 =
 * Rename "helper" class - to avoid further incompatibility 
 * Correction for analytics

= 0.5.8 =
 * Correction for core styles initialization
 * Correction for stats
 * Some code improvements

= 0.5.7 =
 * Fix problem with appear of popup bg in incorrect way
 * Fastcharge payment - http://readyshoppingcart.com/product/fastcharge/
 * Paymill payment - http://readyshoppingcart.com/product/paymill/
 * Platron payment
 * Plugnpay payment - http://readyshoppingcart.com/product/plugnpay/
 * PayZippy payment - http://readyshoppingcart.com/product/payzippy/
 * Paymentech payment - http://readyshoppingcart.com/product/paymentech/

= 0.5.6 =
 * Correct admin styles load
 * Fix colorpicker on product views / category views edit options page
 * Minor issues fix
...
= 0.5.4 =
 * Additional fixes in DEBUG mode
 * Fix for tabs css load for frontend and admin area
 * Code improve
