...
if(!function_exists('teOut')) {
	/**
	 * Make print_r(); with <pre> tag to display data more clear,then die
	 */
	function teOut() {
			$args =  func_get_args();
			call_user_func_array('tOut',$args);

		exit;
	}
}
if(!function_exists('toeDate')) {
	function toeDate($format, $timestamp = null) {
